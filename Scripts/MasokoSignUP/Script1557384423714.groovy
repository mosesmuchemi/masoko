...
WebUI.setText(findTestObject('Page_Create New Customer Account/input_land Islands_mobile'), '+254721388444')

WebUI.setText(findTestObject('Page_Create New Customer Account/input_Personal Information_lastname'), 'Mwendwa')

WebUI.setText(findTestObject('Page_Create New Customer Account/input_Sign-in Information_email'), 'moses.muchemi@gmail.com')
